...
void emulator_reset(Emulator *inst) {
  ...
  MonoMethodDesc *ResetDesc = mono_method_desc_new("mtemu.Emulator:Reset()", 1);
...
MonoObject *emulator_get_command_managed(Emulator *inst, int32_t index) {
  ...
  MonoObject *res =
      mono_runtime_invoke(GetCommand, inst->emul, args, &exception);
...
bool emulator_add_command(Emulator *inst, int32_t index, Command command) {
  ...
  MonoMethodDesc *AddCommandDesc =
      mono_method_desc_new("mtemu.Emulator:AddUserCommand", 1);
  ...
  bool res = mono_object_unbox(
      mono_runtime_invoke(AddCommand, inst->emul, args, NULL));
...
bool emulator_update_command(Emulator *inst, int32_t index, Command command) {
  ...
  args[1] = command_manage(inst, command);
  bool res = mono_object_unbox(
      mono_runtime_invoke(UpdateCommand, inst->emul, args, NULL));
...
Command emulator_last_command(Emulator *inst) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *LastCommandDesc =
      mono_method_desc_new("mtemu.Emulator:LastCommand()", 1);
  MonoMethod *LastCommand =
      mono_method_desc_search_in_class(LastCommandDesc, emulator_class);
  Command res = command_unmanage(
      inst, mono_runtime_invoke(LastCommand, inst->emul, NULL, NULL));
...
int *emulator_remove_command(Emulator *inst, int32_t index) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *RemoveCommandDesc =
      mono_method_desc_new("mtemu.Emulator:RemoveCommand(int)", 1);
  MonoMethod *RemoveCommand =
      mono_method_desc_search_in_class(RemoveCommandDesc, emulator_class);
  void *args[1];
  args[0] = &index;
  MonoObject *exception;
...
int32_t emulator_commands_count(Emulator *inst) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *CommandsCountDesc =
      mono_method_desc_new("mtemu.Emulator:CommandsCount()", 1);
  MonoMethod *CommandCount =
      mono_method_desc_search_in_class(CommandsCountDesc, emulator_class);
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(CommandCount, inst->emul, NULL, NULL));
...
Command emulator_executed_command(Emulator *inst) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *ExecutedCommandDesc =
      mono_method_desc_new("mtemu.Emulator:ExecutedCommand()", 1);
  MonoMethod *ExecutedCommand =
      mono_method_desc_search_in_class(ExecutedCommandDesc, emulator_class);
  Command res = command_unmanage(
      inst, mono_runtime_invoke(ExecutedCommand, inst->emul, NULL, NULL));
...
ResultCode emulator_exec_one(Emulator *inst) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *ExecOneDesc =
      mono_method_desc_new("mtemu.Emulator:ExecOne()", 1);
  MonoMethod *ExecOne =
      mono_method_desc_search_in_class(ExecOneDesc, emulator_class);
  ResultCode res = *(int *)mono_object_unbox(
      mono_runtime_invoke(ExecOne, inst->emul, NULL, NULL));
...
ResultCode emulator_exec_one_call(Emulator *inst) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *ExecOneCallDesc =
      mono_method_desc_new("mtemu.Emulator:ExecOneCall()", 1);
  MonoMethod *ExecOneCall =
      mono_method_desc_search_in_class(ExecOneCallDesc, emulator_class);
  ResultCode res = *(int *)mono_object_unbox(
      mono_runtime_invoke(ExecOneCall, inst->emul, NULL, NULL));
...
ResultCode emulator_exec_all(Emulator *inst) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *ExecAllDesc =
      mono_method_desc_new("mtemu.Emulator:ExecAll()", 1);
  MonoMethod *ExecAll =
      mono_method_desc_search_in_class(ExecAllDesc, emulator_class);
  ResultCode res = *(int *)mono_object_unbox(
      mono_runtime_invoke(ExecAll, inst->emul, NULL, NULL));
...
int32_t emulator_get_next_index(Emulator *inst) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *GetNextIndexDesc =
      mono_method_desc_new("mtemu.Emulator:GetNextIndex()", 1);
  MonoMethod *GetNextIndex =
      mono_method_desc_search_in_class(GetNextIndexDesc, emulator_class);
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetNextIndex, inst->emul, NULL, NULL));
...
int32_t emulator_get_prev_index(Emulator *inst) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *GetPrevIndexDesc =
      mono_method_desc_new("mtemu.Emulator:GetPrevIndex()", 1);
  MonoMethod *GetPrevIndex =
      mono_method_desc_search_in_class(GetPrevIndexDesc, emulator_class);
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetPrevIndex, inst->emul, NULL, NULL));
...
int32_t emulator_get_call_index(Emulator *inst) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *GetCallIndexDesc =
      mono_method_desc_new("mtemu.Emulator:GetCallIndex()", 1);
  MonoMethod *GetCallIndex =
      mono_method_desc_search_in_class(GetCallIndexDesc, emulator_class);
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetCallIndex, inst->emul, NULL, NULL));
...
int32_t emulator_get_pc(Emulator *inst) {
  ...
  MonoMethod *GetPC =
      mono_method_desc_search_in_class(GetPCDesc, emulator_class);
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetPC, inst->emul, NULL, NULL));
...
int32_t emulator_set_pc(Emulator *inst, int32_t value) {
  ...
  MonoMethod *SetPC =
      mono_method_desc_search_in_class(SetPCDesc, emulator_class);
  void *args[1] = {&value};
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(SetPC, inst->emul, args, NULL));
...
int32_t emulator_get_sp(Emulator *inst) {
  ...
  MonoMethod *GetSP =
      mono_method_desc_search_in_class(GetSPDesc, emulator_class);
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetSP, inst->emul, NULL, NULL));
...
int32_t emulator_set_sp(Emulator *inst, int32_t value) {
  ...
  MonoMethod *SetSP =
      mono_method_desc_search_in_class(SetSPDesc, emulator_class);
  void *args[1] = {&value};
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(SetSP, inst->emul, args, NULL));
...
int32_t emulator_get_mp(Emulator *inst) {
  ...
  MonoMethod *GetMP =
      mono_method_desc_search_in_class(GetMPDesc, emulator_class);
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetMP, inst->emul, NULL, NULL));
...
int32_t emulator_get_port(Emulator *inst) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *GetPortDesc =
      mono_method_desc_new("mtemu.Emulator:GetPort()", 1);
  MonoMethod *GetPort =
      mono_method_desc_search_in_class(GetPortDesc, emulator_class);
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetPort, inst->emul, NULL, NULL));
...
int32_t emulator_get_reg_q(Emulator *inst) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *GetRegQDesc =
      mono_method_desc_new("mtemu.Emulator:GetRegQ()", 1);
  MonoMethod *GetRegQ =
      mono_method_desc_search_in_class(GetRegQDesc, emulator_class);
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetRegQ, inst->emul, NULL, NULL));
...
int32_t emulator_get_reg_value(Emulator *inst, int32_t index) {
  ...
  void *args[1] = {&index};
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetRegValue, inst->emul, args, NULL));
...
int32_t emulator_get_f(Emulator *inst) {
  ...
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetF, inst->emul, NULL, NULL));
...
int32_t emulator_get_y(Emulator *inst) {
  ...
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetY, inst->emul, NULL, NULL));
  mono_method_desc_free(GetYDesc);
  mono_free_method(GetY);
  return res;
}

int32_t emulator_get_prev_reg_q(Emulator *inst) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *GetPrevRegQDesc =
      mono_method_desc_new("mtemu.Emulator:GetPrevRegQ()", 1);
  MonoMethod *GetPrevRegQ =
      mono_method_desc_search_in_class(GetPrevRegQDesc, emulator_class);
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetPrevRegQ, inst->emul, NULL, NULL));
  mono_method_desc_free(GetPrevRegQDesc);
  mono_free_method(GetPrevRegQ);
  return res;
}

int32_t emulator_get_prev_reg_a(Emulator *inst) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *GetPrevRegADesc =
      mono_method_desc_new("mtemu.Emulator:GetPrevRegA()", 1);
  MonoMethod *GetPrevRegA =
      mono_method_desc_search_in_class(GetPrevRegADesc, emulator_class);
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetPrevRegA, inst->emul, NULL, NULL));
  mono_method_desc_free(GetPrevRegADesc);
  mono_free_method(GetPrevRegA);
  return res;
}

int32_t emulator_get_prev_reg_b(Emulator *inst) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *GetPrevRegBDesc =
      mono_method_desc_new("mtemu.Emulator:GetPrevRegQ()", 1);
  MonoMethod *GetPrevRegB =
      mono_method_desc_search_in_class(GetPrevRegBDesc, emulator_class);
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetPrevRegB, inst->emul, NULL, NULL));
  mono_method_desc_free(GetPrevRegBDesc);
  mono_free_method(GetPrevRegB);
  return res;
}
...
int32_t emulator_get_r(Emulator *inst) {
  ...
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetR, inst->emul, NULL, NULL));
  mono_method_desc_free(GetRDesc);
  mono_free_method(GetR);
  return res;
}
...
int32_t emulator_get_s(Emulator *inst) {
  ...
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetS, inst->emul, NULL, NULL));
  mono_method_desc_free(GetSDesc);
  mono_free_method(GetS);
  return res;
}
...
int32_t emulator_get_z(Emulator *inst) {
  ...
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetZ, inst->emul, NULL, NULL));
  mono_method_desc_free(GetZDesc);
  mono_free_method(GetZ);
  return res;
}
...
int32_t emulator_get_f3(Emulator *inst) {
  ...
  MonoMethod *GetF3 =
      mono_method_desc_search_in_class(GetF3Desc, emulator_class);
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetF3, inst->emul, NULL, NULL));
  mono_method_desc_free(GetF3Desc);
  mono_free_method(GetF3);
  return res;
}
...
int32_t emulator_get_c4(Emulator *inst) {
  ...
  MonoMethod *GetC4 =
      mono_method_desc_search_in_class(GetC4Desc, emulator_class);
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetC4, inst->emul, NULL, NULL));
  mono_method_desc_free(GetC4Desc);
  mono_free_method(GetC4);
  return res;
}

int32_t emulator_get_ovr(Emulator *inst) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *GetOVRDesc =
      mono_method_desc_new("mtemu.Emulator:GetOvr()", 1);
  MonoMethod *GetOVR =
      mono_method_desc_search_in_class(GetOVRDesc, emulator_class);
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetOVR, inst->emul, NULL, NULL));
  mono_method_desc_free(GetOVRDesc);
  mono_free_method(GetOVR);
  return res;
}
...
int32_t emulator_get_g(Emulator *inst) {
  ...
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetG, inst->emul, NULL, NULL));
  mono_method_desc_free(GetGDesc);
  mono_free_method(GetG);
  return res;
}
...
int32_t emulator_get_p(Emulator *inst) {
  ...
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(GetP, inst->emul, NULL, NULL));
  mono_method_desc_free(GetPDesc);
  mono_free_method(GetP);
  return res;
}
...
void emulator_add_call(Emulator *inst, int32_t index, Call call) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *AddCallDesc =
      mono_method_desc_new("mtemu.Emulator:AddCall()", 1);
  MonoMethod *AddCall =
      mono_method_desc_search_in_class(AddCallDesc, emulator_class);
  void *args[2] = {&index, call_manage(inst, call)};
  mono_object_unbox(mono_runtime_invoke(AddCall, inst->emul, args, NULL));
  mono_method_desc_free(AddCallDesc);
  mono_free_method(AddCall);
}

Call emulator_get_call(Emulator *inst, int32_t index) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *GetCallDesc =
      mono_method_desc_new("mtemu.Emulator:GetCall()", 1);
  MonoMethod *GetCall =
      mono_method_desc_search_in_class(GetCallDesc, emulator_class);
  void *args[1] = {&index};
  Call res =
      call_unmanage(inst, mono_runtime_invoke(GetCall, inst->emul, args, NULL));
  mono_method_desc_free(GetCallDesc);
  mono_free_method(GetCall);
  return res;
}

void emulator_update_call(Emulator *inst, int32_t index, Call call) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *UpdateCallDesc =
      mono_method_desc_new("mtemu.Emulator:UpdateCall()", 1);
  MonoMethod *UpdateCall =
      mono_method_desc_search_in_class(UpdateCallDesc, emulator_class);
  void *args[2] = {&index, call_manage(inst, call)};
  mono_object_unbox(mono_runtime_invoke(UpdateCall, inst->emul, args, NULL));
  mono_method_desc_free(UpdateCallDesc);
  mono_free_method(UpdateCall);
}

void emulator_remove_call(Emulator *inst, int32_t index) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *RemoveCallDesc =
      mono_method_desc_new("mtemu.Emulator:RemoveCall()", 1);
  MonoMethod *RemoveCall =
      mono_method_desc_search_in_class(RemoveCallDesc, emulator_class);
  void *args[1] = {&index};
  mono_object_unbox(mono_runtime_invoke(RemoveCall, inst->emul, args, NULL));
  mono_method_desc_free(RemoveCallDesc);
  mono_free_method(RemoveCall);
}

int32_t emulator_calls_count(Emulator *inst) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *CallsCountDesc =
      mono_method_desc_new("mtemu.Emulator:CallsCount()", 1);
  MonoMethod *CallsCount =
      mono_method_desc_search_in_class(CallsCountDesc, emulator_class);
  int32_t res = *(int32_t *)mono_object_unbox(
      mono_runtime_invoke(CallsCount, inst->emul, NULL, NULL));
  mono_method_desc_free(CallsCountDesc);
  mono_free_method(CallsCount);
  return res;
}

Call emulator_last_call(Emulator *inst) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *LastCallDesc =
      mono_method_desc_new("mtemu.Emulator:LastCall()", 1);
  MonoMethod *LastCall =
      mono_method_desc_search_in_class(LastCallDesc, emulator_class);
  Call res = call_unmanage(
      inst, mono_runtime_invoke(LastCall, inst->emul, NULL, NULL));
  mono_method_desc_free(LastCallDesc);
  mono_free_method(LastCall);
  return res;
}

bool emulator_open_raw(Emulator *inst, uint8_t *bytes, size_t bytes_cnt) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *OpenRawDesc =
      mono_method_desc_new("mtemu.Emulator:OpenRaw(byte[])", 1);
  MonoMethod *OpenRaw =
      mono_method_desc_search_in_class(OpenRawDesc, emulator_class);
  ...
  bool res = *(bool *)mono_object_unbox(
      mono_runtime_invoke(OpenRaw, inst->emul, args, NULL));
...
void emulator_export_raw(Emulator *inst, uint8_t **bytes, size_t *bytes_cnt) {
  MonoClass *emulator_class = mono_object_get_class(inst->emul);
  MonoMethodDesc *ExportRawDesc =
      mono_method_desc_new("mtemu.Emulator:ExportRaw()", 1);
  MonoMethod *ExportRaw =
      mono_method_desc_search_in_class(ExportRawDesc, emulator_class);
  MonoArray *managed_bytes =
...
char *command_get_name(Emulator *inst, Command cmd) {
  ...
  MonoMethodDesc *GetNameDesc =
      mono_method_desc_new("mtemu.Command:GetName()", 1);
  MonoMethod *GetName =
      mono_method_desc_search_in_class(GetNameDesc, command_class);
  char *res = mono_string_to_utf8(
      (MonoString *)mono_runtime_invoke(GetName, command_managed, NULL, NULL));
  mono_method_desc_free(GetNameDesc);
  mono_free_method(GetName);
  return res;
}
...
char *command_get_jump_name(Emulator *inst, Command cmd) {
  MonoObject *command_managed = command_manage(inst, cmd);
  MonoClass *command_class = mono_object_get_class(command_managed);
  MonoMethodDesc *GetJumpNameDesc =
      mono_method_desc_new("mtemu.Command:GetJumpName()", 1);
  MonoMethod *GetJumpName =
      mono_method_desc_search_in_class(GetJumpNameDesc, command_class);
  char *res = mono_string_to_utf8((MonoString *)mono_runtime_invoke(
      GetJumpName, command_managed, NULL, NULL));
  mono_method_desc_free(GetJumpNameDesc);
  mono_free_method(GetJumpName);
  return res;
}
